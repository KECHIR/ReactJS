...
if (typeof this.props.sensor  === 'undifend') { 
...
<form onSubmit={this.handleSubmit} action={this.state.value}>
 ...
 <Route    path="/Ouvreferme" render={(props) =>{ return <Ouvreferme sensor={this.state.tabyeux}/>} }/>
 <Route   path="/TemperatureChambre" component={(props) => < TemperatureChambre sensor={this.state.tabchambre}/> }/>
 <Route   path="/Temperaturesall11" component={(props) => < Temperaturesall11 sensor={this.state.tabA111}/> }/>
 <Route   path="/Attention" component={(props) => < Attention sensor={this.state.tabattention}/> }/>
